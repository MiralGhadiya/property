...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_subscription_plans_country_active", "subscription_plans", ["country_code", "is_active"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.UUID(), nullable=False),
        sa.Column(
            "type", sa.Enum("GENERAL", "VALUATION", "PAYMENT", "SUBSCRIPTION", name="feedback_type"), nullable=False
        ),
        ...
        sa.Column(
            "status", sa.Enum("OPEN", "IN_PROGRESS", "RESOLVED", "CLOSED", name="feedback_status"), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_user_subscriptions_ip_country_code"), "user_subscriptions", ["ip_country_code"], unique=False
    )
    op.create_index(
        op.f("ix_user_subscriptions_payment_country_code"), "user_subscriptions", ["payment_country_code"], unique=False
    )
    ...
    op.create_index(
        "ix_user_subscriptions_pricing_country_code", "user_subscriptions", ["pricing_country_code"], unique=False
    )
    ...
    op.create_index(
        "ix_valuation_reports_country_created_at", "valuation_reports", ["country_code", "created_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_valuation_reports_subscription_id"), "valuation_reports", ["subscription_id"], unique=False
    )
    op.create_index(
        "ix_valuation_reports_user_created_at", "valuation_reports", ["user_id", "created_at"], unique=False
    )
